...
constexpr auto ray_marching(const auto &object, const auto &camera, auto background, auto max_depth,
                            const auto &bounds, auto max_steps, auto epsilon) {
